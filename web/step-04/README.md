...
همانطور که در کد بالا می‌بینید داخل کلاس Calculator،  ازسه پارامتر استفاده می‌کنیم که Num1 و Num2  از نوع decimal بوده و قرار است دو عددی که از کاربر دریافت می‌کنیم را داخل خود نگه دارند و پارامتر finalresult  که از نوع decimal بوده و نتیجه نهایی را در خود نگه می‌دارد.
