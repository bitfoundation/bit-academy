...
همانطور که در کد بالا می‌بینید داخل کلاس Calculator، از دو پارامتر از نوع decimal و یک پارامتر از نوع string استفاده کرده ایم که پارامترهای Num1 و Num2 قرار است دو عددی که از کاربر دریافت می‌کنیم را داخل خود نگه دارند و پارامتر FinalResult نتیجه نهایی را در خود نگه می‌دارد.
