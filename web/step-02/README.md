...
.card {
  Padding: 20px;  /* .برای تعیین  فاصله element از محتوای درون element استفاده می‌شود */
  Margin: 200px auto; /* .برای تعیین فاصله element از محتوای بیرون از element استفاده می‌شود */ 
  Width: 400px;  /* .برای تعیین عرض element استفاده می‌شود */
  Height: 400px;  /* .برای تعین ارتفاع element استفاده می‌شود */
  Background-color: lightskyblue;  /* .برای تعیین رنگ پس زمینه element استفاده می‌شود */
  Box-shadow: 1px 2px 10px 0 #808080;  /* .برای افزودن سایه به element مورد نظر استفاده می‌شود */
  Border-radius: 5px;  /* .باافزودن شعاع به گوشه‌های یک element که در نهایت موجب خمیدگی آن گوشه می‌شود */
}
...
.counter {
  ...
  width: 150px;
  height: 150px;
  line-height: 150px; /* .متن داخل element به اندازه مقداری که داده شده از خط قبل و بعد فاصله می‌گیرد */
  background-color: #eee;
  border-radius: 50%;  /* .با دادن این مقدار به این پراپرتی element دایره‌ای شکل می‌شود */
  border: 10px solid #2196f3; /* .استایل، عرض و رنگ حاشیه element را مشخص می‌کند  */
  text-align: center;  /* .نحوه چیدمان متن داخل element را مشخص می‌کند */
  font-size: 60px;  /* .سایز فونت متن داخل element را مشخص می‌کند */
  Font-weight: bold;  /* .ضخامت متن داخل element را مشخص می‌کند */
  color: #107732;  /* .رنگ متن داخل element را مشخص می‌کند */
}
...
قبل از ورود به فایل counter.js در همین فایل counter.html برای المنتی که می‌خواهیم محتوای درونش با هر کلیک کاربر،  بر روی دکمه‌ها آپدیت شود، یک شناسه منحصر به فرد یا همان ویژگی id را  به صورت کد زیر تعیین می‌کنیم.
