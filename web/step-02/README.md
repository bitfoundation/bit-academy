...
<img width="400px" src="images/img-1.png" />
  ...
  در ابتدا پوشه ای به اسم  SimpleCounter  در مسیر دلخواه ایجاد می‌کنیم.
...
.counter {
  ...
  width: 150px;
  height: 150px;
  line-height: 150px; /* .متن داخل المنت به اندازه مقداری که داده شده از خط قبل و بعد فاصله بگیرد */
  background-color: #eee;
  border-radius: 50%;  /* .با دادن این مقدار به این پراپرتی المنت دایره‌ای شکل می‌شود */
  border: 10px solid #2196f3; /* .استایل، عرض و رنگ حاشیه لمنت را مشخص می‌کند  */
