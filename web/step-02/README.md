...
Selector: به منظور اضافه نمودن استایل به یک المنت، باید آن المنت را انتخاب کنیم. یکی از روش های انتخاب المنت در CSS، استفاده از نام خود المنت می‌باشد. 
 Property: با استفاده از Property ها، ویژگی‌های نمایش یک المنت در HTML  را تعیین می‌کنیم. 
Property value: برای هر Property یا ویژگی در CSS باید یک مقدار در نظر گرفته شود. به عنوان مثال در این تصویر، رنگ قرمز را برای پراپرتی color المنت یا تگ p در نظر گرفتیم.
