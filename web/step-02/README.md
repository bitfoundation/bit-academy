...
Selector: به منظور اضافه نمودن استایل به یک المنت، باید آن المنت را انتخاب کنیم. یکی از روش های انتخاب المنت در CSS، استفاده از نام خود المنت می‌باشد.  برای مثال در تصویر بالا ما از نام تگ button به عنوان سلکتور استفاده کرده‌ایم،  به  این معنا که می‌خواهیم استایلی را برای تمامی  button  های موجود در صفحه تعیین کنیم. 
 ...
 Property: با استفاده از Property ها، ویژگی‌های نمایش یک المنت در HTML  را تعیین می‌کنیم. به عنوان مثال اگر بنویسیم background-Color: blue، به این معناست که رنگ پس زمینه تمامی button های موجود در صفحه آبی باشد.

Property value: برای هر Property یا ویژگی در CSS باید یک مقدار در نظر گرفته شود. به عنوان مثال در این تصویر، رنگ قرمز را برای پراپرتی color المنت یا تگ button در نظر گرفتیم.
