...
<img src="images/img-14.jpeg" width="700px"/>
...
همان‌طور که در تصویر می‌بینید، این صفحه در سه سایز Desktop, Tablet و Mobile  طراحی شده است. که در سایز دسکتاپ، بخش مربوط به Login کاربر، از دو بخش تشکیل شده است، که در یک بخش، فرم Login قرار گرفته و در بخش بعدی، لوگو محصول به اضافه توضیح کوتاهی در مورد محصول قرار گرفته است. 

در سایز تبلت به دلیل کمبود فضا بخش اصلی، که همان فرم Login است نگه داشته شده، همچنین لوگو مربوط به پروژه هم به قسمت بالای فرم Login و با رنگی متفاوت از لوگو در سایز دسکتاپ قرار گرفته است.

و در سایز موبایل، به دلیل برابری تقریبی سایز صفحه نمایش موبایل با باکس سفید، باکس سفید هم حذف شده است.
