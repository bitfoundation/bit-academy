...
قبل از اختصاص پراپرتی‌ها به کلاس container، لازم است بدانید که ما از بین روش‌های متفاوتی که برای چیدمان المنت‌ها(Layout) صفحه وجود دارد روش Flexbox را انتخاب کرده‌ایم. 
