...
قبل از شروع به پیاده سازی صفحه Login می‌خواهیم به بررسی طرح این صفحه، که از قبل، توسط تیم طراحی به وسیله ابزاری به نام Figma ایجاد شده است بپردازیم.
...
​بعد از اتمام مراحل نصب، به ساختار پروژه برمی‌گردیم، ابتدا پوشه جدیدی به نام images در فولدر wwwroot ایجاد کنید، در ادامه image هایی که از فیگما export کردین را با drag & drop  داخل این پوشه بگذارید تا در ادامه از این image ها استفاده کنیم.


سپس کد زیر را به منظور ایجاد ساختار صفحه Login پروژه در این فایل وارد نمایید.
...
سپس برای افزودن استایل‌ها فایل جدیدی به نام LoginPage.razor.scss ایجاد می کنیم.
...
در ادامه فایل جدیدی به نام LoginPage.razor.cs ایجاد می‌کنیم.
...
در مرحله آخر می‌خواهیم از پارامترها و متد تعریف شده در این فایل، در فایل LoginPage.razor استفاده کنیم.
