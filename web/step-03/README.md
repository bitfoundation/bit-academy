<div dir="rtl">
 ...
 در مرحله بعد مطابق تصویر زیر از لیست ارایه شده ‌Blazor WebAssembly App را انتخاب و با کلیک بر روی دکمه Next به مرحله بعدی می‌رویم.
  ...
  <img width="500px" src="images/img-2.png" />
   ...
   همان طور که در تصویر زیر می‌بینید در قسمت Project name می‌توانیم اسم پروژه را انتخاب و در قسمت Location محل قرار گیری پروژه را مشخص کنیم. مجددا برای رفتن به مرحله بعد بر روی دکمه Next کلیک می‌کنیم.
