<div dir="rtl">
 ...
 در این جلسه قصد داریم شمارنده جلسه پیش را با استفاده از Blazor  پیاده سازی کنیم. Blazor به شما اجازه می‌دهد که با همان HTML/CSS کار کنید، ولی به جای JavaScript، از #C  استفاده کنید.
