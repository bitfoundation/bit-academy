<div dir="rtl">
 ...
 در این جلسه قصد داریم شمارنده جلسه پیش را با استفاده از Blazor  پیاده سازی کنیم. Blazor به شما اجازه می‌دهد که با همان HTML/CSS کار کنید، ولی به جای JavaScript، از C# .NET استفاده کنید.
...
پوشه Properties، داخل این پوشه یک فایل به نام launchSettings.json قرار گرفته که تنظیمات مربوط به راه اندازی  برنامه در آن است، برای مثال در برنامه ای که چندین صفحه دارد، کدام صفحه پیش‌فرض باز شود.


پوشه wwwroot، در این پوشه فایل های استاتیک مانند فایل های css ,font ,image و… قرار دارند. 

پوشه Pages، در این پوشه صفحات پروژه  با پسوند razor قرار گرفته‌اند. فایل razor، شبیه به فایل html قسمت قبل است، با این تفاوت که امکاناتی از C# .NET به آن اضافه شده است.
