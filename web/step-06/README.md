...
همچنین RowTemplate داخل کامپوننت BitBasicList هر سطر از لیست که یک TodoItem می‌باشد را ایجاد می‌کند، که همانطور که می‌بینید شما می‌توانید هر آنجه را که از TodoItem می‌خواهید به کاربر نمایش دهید داخل RowTemplate بگذارید.
