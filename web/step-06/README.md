...
این دستور به این صورت کار می کند که ابتدا  switch expression یکبار ارزیابی می‌شودو سپس مقدار expression با مقدار هر case مقایسه می‌شود و در صورت مطابقت بلاک کد مرتبط اجرا می‌شود.


هنگامی که #C به یک break می رسد ، از بلاک switch خارج می شود. در واقع case مورد نظر پیدا شده کد مربوط به بلاک مرتبط پس از اجرا وقتی به break می‌رسد متوقف می شود و به اجرای ادامه کد داخل بلاک نمی‌پردازد.
